...
if getgenv().unknownRan then
	warn("ALREADY OPEN")
	return
end
getgenv().unknownRan=true
...
local L_33_ = loadstring(game:HttpGet("https://raw.githubusercontent.com/KINNYSPENCER/Bloxfruit/refs/heads/main/Bloxfruit%20ui.txt"))()
local L_34_ = L_33_:Window("unknownhub Hub unknown was here", Enum.KeyCode.LeftControl)
print("|unknownhub DEBUG| Anti AFK")
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|unknownhub DEBUG| AFK detected, prevented +1")
...
spawn(function()
	print("|unknownhub DEBUG| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("unknownhub Hub found an Admin!")
						print("|unknownhub DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|unknownhub DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|unknownhub DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
L_35_.Info:Button("My Discord (Click Copy)", function()
	setclipboard("https://discord.gg/AU4CnDTbxt")
end)
L_35_.Info:Button("link button (Click Copy)", function()
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|unknownhub DEBUG| Remove Effects")
...
print("|unknownhub DEBUG| Done loaded unknownhub in: " .. os.clock() - L_1_)
